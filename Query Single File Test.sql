...
CASE
        ...
        THEN 'Customs'
        WHEN BD.BILLING_CODE IN ('2115','4007','4024','4597','4643','4645','V163','V192','V197','0130','0131','2106','4401','4403','4423','4429','4480','V093')
        THEN 'Destination & Delivery Charges'
...
and  CIF.INVOICE_NUMBER IN ('C20404195','E20460647','E20460673','E222558324','E370281934')
),
...
SELECT MAX(NCD.MASTER_CLIENT_NUMBER) as "Importer Master Client Number",
       ...
       MAX(PORT_ORIGIN.COUNTRY_NAME) as "Origin Branch Country Name",
       MAX(PORT_DEST.COUNTRY_NAME) as "Destination Branch Country Name",
...
WHERE (CASE WHEN '$(Client Type)' = 'MASTER' THEN NCD.MASTER_CLIENT_NUMBER ELSE NCD.GCI END) IN ('$(Master Client Number)')
AND ISF.INVOICE_NUMBER IN ('C20404195','E20460647','E20460673','E222558324','E370281934')
...
WHERE   (CASE WHEN '$(Client Type)' = 'MASTER' THEN NCD.MASTER_CLIENT_NUMBER ELSE NCD.GCI END) IN ('$(Master Client Number)')
and  IM.INVOICE_NUMBER IN ('C20404195','E20460647','E20460673','E222558324','E370281934')
GROUP BY
SF.MOVEMENT_ID
),
...
(select 
        ...
        OP.COUNTRY_NAME as "Origin Branch Country Name",
        DP.COUNTRY_NAME as "Destination Branch Country Name",
...
SF.VOLUME,IM.INVOICE_NUMBER,OP.COUNTRY_NAME,DP.COUNTRY_NAME,BOD.BRANCH_CODE,BDD.BRANCH_CODE,
...
WHERE QUERY."INVOICE EXPEDITOR" IN ('C20404195','E20460647','E20460673','E222558324','E370281934')
